      ...
      <div class="main-register">
        ...
        <el-row>
          <el-form  :model="registerForm" status-icon :rules="rules" size="medium" ref="registerForm" label-width="100px" class="demo-registeForm">
            ...
            <el-form-item label="用户名" prop="username">
              <el-input @keyup.enter.native="Register('registerForm')" v-model="registerForm.username" autocomplete="off" placeholder="请输入密码(8-15位)" show-password>
              </el-input>
            </el-form-item>
            <el-form-item label="密码" prop="pass">
              <el-input @keyup.enter.native="Register('registerForm')" v-model="registerForm.pass" autocomplete="off" placeholder="请输入密码(8-15位)" show-password>
              </el-input>
            </el-form-item>
            ...
            <el-form-item style="margin-left: -25%">
              ...
              <div class="link" style="margin-top: -6px;float:left;">
                <el-link type="primary"><router-link to="/login">已有账号?去登录</router-link></el-link>
              </div>
...
<script>
    ...
    data() {
      ...
      return {
        ...
        // 检查密码验证规则
        captcha: [
          { required: true, validator: validateCap, trigger: 'blur' }
        ],
        },
      };
    },
