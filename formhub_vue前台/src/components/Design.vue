        ...
        >
          ...
          >
            <el-row>
              <el-col :span="16">
                <el-input
                  @change="updateOption(item.title, item.id, index)"
                  maxLength="255"
                  v-model="item.title"
                  placeholder="请输入选项名(255字)"
                  style="width: 90%;"
                ></el-input>
              </el-col>
              <el-col :span="8">
                <el-button
                  ...
                  plain
                  class=""
                  @click="deleteOption(item.id, index, item.qid)"
                  >删除选项</el-button
                >
              </el-col>
            </el-row>
  ...
  methods: {
    ...
    editorQuestion(item) {
      ...
      this.willAddQuestion.type =
        item.qtype == 1 ? "radio" : item.qtype == 2 ? "checkbox" : "text";
